...
### MVC (API Gateway, User, Catalog, Search, Cart, Payment, Notification, Analytics)
...
|---|---|---|---|---|
| 0 | API Gateway | 8080 | Redis (rate limit) | — |
| 1 | Auth Service | 8081 | PostgreSQL + Redis | Producer |
| 2 | User Service | 8082 | PostgreSQL | Producer |
| 3 | Catalog Service | 8083 | PostgreSQL + Redis | Producer |
| 4 | Search Service | 8084 | Elasticsearch | Consumer |
| 5 | Cart Service | 8085 | Redis | — |
| 6 | Order Service | 8086 | PostgreSQL | Producer + Consumer |
| 7 | Payment Service | 8087 | PostgreSQL | Producer |
| 8 | Notification Service | 8088 | — (stateless) | Consumer |
| 9 | Analytics Service | 8089 | Cassandra | Consumer |
...
**Spec:** [docs/microservices/00-api-gateway.md](microservices/00-api-gateway.md)
...
**Specs:**
- Auth Service → [docs/microservices/01-auth-service.md](microservices/01-auth-service.md)
- User Service → [docs/microservices/02-user-service.md](microservices/02-user-service.md)
...
**Spec:** [docs/microservices/06-order-service.md](microservices/06-order-service.md)
...
**Spec:** [docs/microservices/07-payment-service.md](microservices/07-payment-service.md)
...
**Spec:** [docs/microservices/08-notification-service.md](microservices/08-notification-service.md)
...
**Spec:** [docs/microservices/09-analytics-service.md](microservices/09-analytics-service.md)
